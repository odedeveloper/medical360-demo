...
class SearchController extends GetxController {
  ...
  Future<dynamic> sendRequest(myText) async {
    const String API_URL =
        "https://hgqg4q8s9h.execute-api.us-east-1.amazonaws.com/prod/enterprise/dataVault";
    ...
    if (queryType == 1) {
      ...
      response = await http.post(Uri.parse(API_URL),
          body: jsonEncode(<String, String>{'query': myText}));
      ...
      response = await http.post(
        Uri.parse(API_URL),
        body: jsonEncode(<String, dynamic>{'query': myText, 'year': 2021}),
      );
